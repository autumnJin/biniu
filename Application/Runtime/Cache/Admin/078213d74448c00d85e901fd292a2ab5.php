    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-8 am-u-md-push-1">
          <form class="am-form am-form-horizontal" action="<?php echo U('sysswitch');?>" method="post">
            <input type="hidden" name="id" value="1">
            <div class="am-form-group">
              <label for="user-QQ" class="am-u-sm-3 am-form-label">关闭系统</label>
             <div class="am-u-sm-9">
               <label class="am-radio-inline">
                 <input type="radio" name="is_open" value="2" <?php if($data['is_open'] == 2) echo 'checked' ?> data-am-ucheck checked> 是
               </label>
               <label class="am-radio-inline">
                 <input type="radio" name="is_open" value="1"  <?php if($data['is_open'] == 1) echo 'checked' ?> data-am-ucheck> 否
               </label>
             </div>
            </div>
            <div class="am-form-group">
