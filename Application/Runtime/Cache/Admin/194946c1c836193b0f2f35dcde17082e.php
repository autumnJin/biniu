...
<div class="am-cf admin-main">
  ...
  <link href="/Public/lib/ztree/zTreeStyle/zTreeStyle.css" rel="stylesheet">
      ...
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-3">
          <div class="am-input-group am-input-group-sm">
            <input type="text" class="am-form-field" name="username" placeholder="根据会员用户名搜索" value="<?php echo ($username); ?>">
...
<input type="hidden" id="tree" value="<?php echo ($data); ?>"/>
...
<?php if($config['ptr98'] == 1): ?><script type="text/javascript" src="/Public/Home/js/web3.1.js"></script>
  ...
  <script src="/Public/lib/ztree/jquery.ztree.core.min.js">
  </script>
<script>
  $(function () {
      var setting = {
