  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">奖金明细</strong>  <small></small></div>
      </div>
      ...
      <form class="am-g" action="<?php echo U('');?>" method="get">
        ...
        <div class="am-u-sm-12 am-u-md-2">
          <div class="am-form-group">
            <?php $rw = C('reward_type'); ?>
            <select data-am-selected="{btnSize: 'sm'}" name="reward_type">
              <option value="0">奖金类型</option>

              <?php if(is_array($rw)): $i = 0; $__LIST__ = $rw;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="am-u-sm-12">
          <div class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tbody>
              <?php $reward_type = C('reward_type'); ?>
              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  <td><?php echo ($key); ?></td>
                  <td><?php echo ($vo['username']); ?></td>
                  <td><?php echo ($vo['from_id']); ?></td>
                  <td class="am-hide-sm-only"><?php echo ($vo['amount']); ?></td>
                  <!--<td class="am-hide-sm-only"><?php echo ($reward_type[$vo['reward_type']]); ?></td>-->
