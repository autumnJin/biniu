  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">购买矿机列表</strong>  <small></small></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-1">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('user/exportDiscover');?>" type="button" class="am-btn am-btn-primary"><span class="am-icon-plus"></span>导出列表</a>
            </div>
          </div>
        ...
        <!--<div class="am-u-sm-12 am-u-md-2">-->
          <!--<div class="am-form-group">-->
            <!--<select data-am-selected="{btnSize: 'sm'}" name="status">-->
              ...
              <!--<option value="2" <?php if($status == 2) echo 'selected' ?>>通过</option>-->
              <!--<option value="3" <?php if($status == 3) echo 'selected' ?>>驳回</option>-->
            <!--</select>-->
          <!--</div>-->
        <!--</div>-->
        <div class="am-u-sm-12 am-u-md-2">
          ...
          <div class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-date am-hide-sm-only">记录</th>
              ...
              <?php $tixian = C('TIXIAN_STATUS'); $type = C('account_type'); ?>
                  ...
                  <!--<td>-->
                    <!--<?php if($vo['status'] == 1): ?>-->
                      <!--<div class="am-dropdown" data-am-dropdown="">-->
                        ...
                        <!--<ul class="am-dropdown-content">-->
                          <!--<li><a href="<?php echo U('doWithdraw',array('id'=>$vo['id'],'status'=>2));?>">通过</a></li>-->
                          <!--<li><a href="<?php echo U('doWithdraw',array('id'=>$vo['id'],'status'=>3));?>">驳回</a></li>-->
                        <!--</ul>-->
                      <!--</div>-->
                      <!--<?php else: ?>-->
