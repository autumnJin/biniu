  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">流水明细</strong>  <small></small></div>
      </div>
      ...
      <form class="am-g" action="<?php echo U('');?>" method="get">
        ...
        <!--</div>-->
        <div class="am-u-sm-12 am-u-md-2">
          <input type="text" class="am-form-field" name="start_time"  value="<?php echo ($start_time); ?>" placeholder="开通开始时间" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',readOnly:true})" readonly/>
        </div>
        <div class="am-u-sm-12 am-u-md-2">
          <input type="text" class="am-form-field" name="end_time"  value="<?php echo ($end_time); ?>" placeholder="开通开始时间" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',readOnly:true})" readonly/>
        </div>
        <div class="am-u-sm-12 am-u-md-2">
          <div class="am-form-group">
            <?php $c = C('account_type'); ?>
            <select data-am-selected="{btnSize: 'sm'}" name="type">
              <option value="0">账户类型</option>

              <?php if(is_array($c)): $i = 0; $__LIST__ = $c;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($type == $key) echo 'selected' ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="am-u-sm-12 am-u-md-3">
          <div class="am-input-group am-input-group-sm">
            <input type="text" class="am-form-field" name="username" placeholder="用户名精确查找" value="<?php echo ($username); ?>">
          </div>
        </div>
          ...
          <div class="am-form">
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-date am-hide-sm-only">关联账户</th>
              </tr>
              </thead>
              <tbody>
              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td class="am-hide-sm-only"><?php echo ($vo['flag']); echo ($vo['amount']); ?></td>
                  <td class="am-hide-sm-only"><?php echo ($vo['tips']); ?></td>
                  <td class="am-hide-sm-only"><?php echo ($a[$vo['type']]); ?></td>
