...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="<?php echo U('news/add_news2');?>" type="button" class="am-btn am-btn-primary"><span class="am-icon-plus"></span> 新增</a>
                        </div>
                    </div>
                </div>
                    ...
                    <!--<form class="am-form">-->
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <?php echo $vo['type'] == 1 ? '商城新闻':'医院简介' ?>
                                    </td>
                                    <td><?php echo (date("Y/m/d H:i:s",$vo['create_time'])); ?></td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="<?php echo U('edit_news2',array('id'=>$vo['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                                <!--<button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only  del"  user_id=<?php echo ($vo['id']); ?> ><span class="am-icon-trash-o"></span> 删除</button>-->
                                                <button class="del am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"  onclick="del(<?php echo ($vo['id']); ?>);"  user_id=<?php echo ($vo['id']); ?>><span class="am-icon-trash-o"></span> 删除</button>
                                            </div>
                                        </div>
                                    </td>
        ...
        <script>
            var url11 = "<?php echo U('deleteNews2');?>";
            function del(id){
                if(confirm('确认删除此公告吗?')){
