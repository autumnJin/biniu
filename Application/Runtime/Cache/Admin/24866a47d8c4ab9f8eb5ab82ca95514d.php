        ...
        <div class="admin-content-body">
            ...
            <div class="am-g">
                <div class="am-u-sm-12 am-u-md-8 am-u-md-push-1">
                    <form class="am-form am-form-horizontal" action="<?php echo U('add_edit_news2');?>" method="post">
                        <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">公告名称</label>
                            <div class="am-u-sm-9">
                                <input type="text" id="user-name" placeholder="" required name="title" value="<?php echo ($data["title"]); ?>">
                            </div>
                        </div>

                        <!--<div class="am-form-group">-->
                        <!--<label for="user-email" class="am-u-sm-3 am-form-label">公告内容</label>-->
                        <!--<div class="am-u-sm-9">-->
                        <!--<textarea class="" rows="5" id="doc-ta-1"  name="content" required><?php echo ($data["content"]); ?></textarea>-->
                        <!--</div>-->
                        <!--</div>-->

                        <div class="am-form-group">

                            <label for="doc-ta-1" class="am-u-sm-3 am-form-label">公告内容</label>
                            <div class="am-u-sm-9">
              <textarea style="min-width: 628px" id="container" name="content" type="text/plain">
                        ...
                        <!--<div class="am-form-group">-->
                        <!--<label for="user-QQ" class="am-u-sm-3 am-form-label">公告类别</label>-->
                        <!--<div class="am-u-sm-9">-->
                        <!--<select data-am-selected="{btnSize: 'sm'}" name="type">-->
                        <!--<option value="1" <?php if($data['type'] == 1) echo 'selected' ?>>商城新闻</option>-->
                        <!--<option value="2" <?php if($data['type'] == 2) echo 'selected' ?>>医院简介</option>-->
                        <!--</select>-->
                        <!--</div>-->
                        <!--</div>-->
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <label class="am-radio-inline">
                                    <input type="radio" name="status" value="1" <?php if($data['status'] == 1 || !isset($data['status'])) echo 'checked' ?> data-am-ucheck> 是
                                </label>
                                <label class="am-radio-inline">
                                    <input type="radio" name="status" value="2" <?php if($data['status'] == 2) echo 'checked' ?> data-am-ucheck> 否
                                </label>
                            </div>
                        </div>
